...
#define SDL_WINDOW_STARTING_SIZE_W 1920//EDITOR_FIXED_INTERNAL_RESOLUTION_W*2
#define SDL_WINDOW_STARTING_SIZE_H 1080//EDITOR_FIXED_INTERNAL_RESOLUTION_H*2
